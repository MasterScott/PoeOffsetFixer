...
namespace HudOffsetFixer.MemorySections
{
    public class MemorySectionsProcessor
    {
        public static MemorySectionsProcessor Instance;
        ...
        public MemorySectionsProcessor()
        {
            ...
            _enumerateRemoteSectionsAndModulesDelegate = GetFunctionDelegate<EnumerateRemoteSectionsAndModulesDelegate>(handle, "EnumerateRemoteSectionsAndModules");
            Instance = this;
        }
        ...
        {
            _enumerateRemoteSectionsAndModulesDelegate(process, callbackSection, callbackModule);
        }
